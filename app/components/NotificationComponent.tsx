                ...
                {data.map((d) =>(
                    <div className={styles.msg} key={d.id}>
                        ...
                        <div className={styles.userMsg}>
                            ...
                            {d.state == "ModReview" && <p>One of our student has requested to issue an item..<br/><br/>Item Name: <span className={styles.red}>{d.itemName}</span>, quantity: <span className={styles.red}>{d.quantity}</span><br/><br/> Here&sbquo;s what they want to say:{d.description}<br /><br />
